...
pub fn map_rusqlite_error(err: SqliteError) -> DataLayerError {
...
fn is_no_such_table(err: &SqliteError) -> bool {
    match err {
        SqliteError::SqliteFailure(_, Some(msg)) => msg.contains("no such table"),
