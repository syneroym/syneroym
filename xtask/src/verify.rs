...
fn parse_skip_args(args: impl Iterator<Item = String>) -> Result<HashSet<String>> {
...
mod tests {
    ...
    fn parse_skip_args_collects_repeated_flags() -> Result<()> {
        ...
        let skip = parse_skip_args(args.into_iter())?;
    ...
    fn parse_skip_args_rejects_unknown_flag() {
        ...
        assert!(parse_skip_args(args.into_iter()).is_err());
    }
