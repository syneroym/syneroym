...
pub use directory::DirectoryCommands;
...
pub async fn handle(
    ...
    match command {
        ...
        RoymCommands::Address { domain } => {
            ...
            let mut client =
                crate::commands::client_for(substrate_did, api_url, dir, run_as, ucan_path)?;
...
pub(super) fn find_roym_service(svcs: &[DeployedService], name: &str) -> Result<String> {
