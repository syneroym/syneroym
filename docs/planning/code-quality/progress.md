...
| 2 | shared `common/fixtures.rs` + supervisor family: `supervisor_loop_e2e`, `supervisor_interface_e2e`, `scheduled_task_e2e`, `health_monitoring_e2e`, `tier1_endpoint_record_e2e`, `app_instance_identity_e2e`, `instance_identity_e2e` | in progress |
