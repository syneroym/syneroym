...
| G5b | Planning refs outside .rs (.wit/.toml/.ts) | done | [#268](https://github.com/syneroym/syneroym/pull/268) |
...
| G8 | Dynamic port allocation in e2e tests | done | [#271](https://github.com/syneroym/syneroym/pull/271) |
| G9 | Increase substrate e2e nextest concurrency | done | [#272](https://github.com/syneroym/syneroym/pull/272) |
| G10 | Shared test helpers: `deploy_app`/`try_deploy_app` (7+4-copy), `one_service_manifest` (4-copy); lower duplication threshold | done | [#273](https://github.com/syneroym/syneroym/pull/273) |
...
| `crates/roym_web` | 0 | 0 | 0 | 3 | n/a | n/a | done |
| `crates/auth` | 0 | 0 | 1 | 3 | n/a | n/a | done |
| `crates/roym_core` | 0 | 0 | 2 | 0 | n/a | done | n/a |
| `crates/roym_catalog` | 0 | 0 | 1 | 1 | n/a | done | done |
