...
| Slice | Plan | State |
|---|---|---|
| S1 | [slice-s1-implementation-plan.md](slice-s1-implementation-plan.md) | 📋 Planned, full detail |
| S2 | *(not written)* | Sketch in [task.md](task.md); owes its own `§0`, which must settle §0.4 |
